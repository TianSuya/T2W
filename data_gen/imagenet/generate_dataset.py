...
class TinyImageNet(Dataset):
    def __init__(self, root, train=True, transform=None, class_names=None):
        ...
        self.class_names = class_names  # Additional parameter for class filtering
    ...
    def _make_dataset(self, Train=True):
        ...
        if Train:
            ...
            # Select directories based on whether filtering classes
